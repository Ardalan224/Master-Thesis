# -*- coding: utf-8 -*-
"""Popularity_RecPack_Amazon_CDs_and_Vinyl_UserBasedSplit+10_Core_Pruning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tvCJVtH2O9ELdO5phpyqnL5IgGyUcPUo
"""
...
# 0.42
test_valid_scenario = WeakGeneralization(frac_data_in=0.42, validation=False, seed=42)
...
# Amazon_CDs:  10% = 0.079....20% = 0.178....30% = 0.273....40% = 0.375....50% = 0.475....60% = 0.575....70% = 0.670....80% = 0.777....90% = 0.876...100% = 1.0
downsample_fraction = 0.876
