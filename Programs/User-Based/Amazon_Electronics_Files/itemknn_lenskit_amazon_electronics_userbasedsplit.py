# -*- coding: utf-8 -*-
"""ItemKNN(Updated_nDCG)_LensKit_Amazon_Electronics_UserBasedSplit+10_Core_Pruning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aTRQl-pYQ755TUdJuwiRF5M6vmkIbp_5
"""
...
# Create a bar plot for the average number of interactions
# Define the stats dictionary here
stats = {'Average': average_interactions}

plt.figure(figsize=(8, 6))  # Wider figure
plt.bar(stats.keys(), stats.values(), color='orange', width=0.1)  # Narrower bar width

# Manually adjust the x-axis limits
plt.xlim(-0.5, 0.5)

plt.title('Average Number of Interactions per User after pruning, Amazon Toys & Games')
plt.xlabel('Statistic')
plt.ylabel('Number of Interactions')
plt.ylim(0, average_interactions + 10)  # Adjust y-axis for better visualization
plt.show()
