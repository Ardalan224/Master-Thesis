# -*- coding: utf-8 -*-
"""FunkSVD(Updated_nDCG)_LensKit_Gowalla_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wSxY0qAxtw23_2PzWHGyUSZcmXB3jepf
"""
...
for iterations in iteration_values:
    for features in feature_values:
        ...
        valid_recs, mean_ndcg = evaluate_with_ndcg('FunkSVD', algo_funksvd, pure_train_data, validation_data)
...
final_recs, mean_ndcg = evaluate_with_ndcg('FunkSVD', final_algo, pure_train_data, final_test_data)
