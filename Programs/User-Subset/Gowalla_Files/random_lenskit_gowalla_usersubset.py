# -*- coding: utf-8 -*-
"""Random(Updated_nDCG)_LensKit_Gowalla_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1dF1xmrdw6bY-CUXaZHQBFsvXQCaJI93P
"""
...
algo_random = Random()
valid_recs, mean_ndcg = evaluate_with_ndcg('Random', algo_random, pure_train_data, validation_data)
...
final_recs, mean_ndcg = evaluate_with_ndcg('Random', final_algo, pure_train_data, final_test_data)
