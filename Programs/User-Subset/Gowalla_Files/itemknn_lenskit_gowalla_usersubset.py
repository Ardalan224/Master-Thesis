# -*- coding: utf-8 -*-
"""ItemKNN(Updated_nDCG)_LensKit_Gowalla_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DFFtZTpCZzYlb2i89B8ULnf-cVzpBQYO
"""
...
k_values = [1, 3, 5, 7, 15, 30, 50, 100]

for k in k_values:
    seedbank.initialize(42)
    algo_ii = knn.ItemItem(nnbrs=k, center=False, aggregate='sum', feedback="implicit")

    valid_recs, mean_ndcg = evaluate_with_ndcg('ItemItem', algo_ii, pure_train_data, validation_data)
...
final_algo = knn.ItemItem(nnbrs=best_k, center=False, aggregate='sum', feedback="implicit")

# Use evaluate_with_ndcg to get recommendations and mean nDCG
final_recs, mean_ndcg = evaluate_with_ndcg('ItemItem', final_algo, pure_train_data, final_test_data)
