# -*- coding: utf-8 -*-
"""ItemKNN_RecPack_Gowalla_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lnZgu1cE5bY0oXiifZ0YKK8-4VVgBD-i
"""
...
# 28%----> 0.73      36%----> 0.58    44%-----> 0.47     52%----> 0.395     60%----> 0.345     68%----> 0.305      76%----> 0.275       84%----> 0.25       92%----> 0.23         100%----> 0.220
test_valid_fraction = 0.23
...
# 28%----> 0.48     36%----> 0.475    44%-----> 0.47         52%----> 0.46    60%----> 0.455    68%---> 0.445     76%---> 0.445      84%----> 0.44        92%----> 0.44       100%---> 0.41
...
pipeline_builder.add_algorithm(
    'ItemKNN',
    grid={
        'K': [5, 10, 20, 40, 60, 80, 100, 150, 200, 300, 400, 500, 600, 700, 800, 900, 1000],  # Range of K values for optimization
    }
)
