# -*- coding: utf-8 -*-
"""UserKNN(Updated_nDCG)_LensKit_Gowalla_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GC9Jpzrj0InRxQN-7-fsclHARN5rj_tL
"""
...
k_values = [1, 3, 7, 10, 15, 30, 50, 100]

# Iterate over each K value
for k in k_values:
    seedbank.initialize(42)
    algo_uu = knn.UserUser(nnbrs=k, center=False, aggregate='sum', feedback="implicit")

    valid_recs, mean_ndcg = evaluate_with_ndcg('UserUser', algo_uu, pure_train_data, validation_data)
...
final_algo = knn.UserUser(nnbrs=best_k, center=False, aggregate='sum', feedback="implicit")

# Use evaluate_with_ndcg to get recommendations and mean nDCG
final_recs, mean_ndcg = evaluate_with_ndcg('UserUser', final_algo, pure_train_data, final_test_data)
