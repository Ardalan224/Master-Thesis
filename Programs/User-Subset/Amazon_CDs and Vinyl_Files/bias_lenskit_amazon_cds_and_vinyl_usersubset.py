# -*- coding: utf-8 -*-
"""Bias(Updated_nDCG)_LensKit_Amazon_CDs_and_Vinyl_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1R3r43kXQJ-4No9U0WGPXfyIg_eo0BbnF
"""
...
# 10% validation + 10% test set + n% of the training based on the desired downsampling portion----> 0.28      0.36        0.44      0.52      0.60      0.68     0.76     0.84      0.92      1.0
import random
...
# 28--> 0.35     36---> 0.28   44---> 0.23     52---> 0.19     60---> 0.17     68---> 0.145      76-----> 0.13     84----> 0.12         92----> 0.11        100-----> 0.10
...
# 28---> 0.56   36---> 0.38    44---> 0.30     52---> 0.23     60---> 0.20    68----> 0.17       76----> 0.15      84----> 0.135        92----> 0.125        100-----> 0.11
...
valid_recs, mean_ndcg = evaluate_with_ndcg('Bias', algo_bias, pure_train_data, validation_data)
...
final_recs, mean_ndcg = evaluate_with_ndcg('Bias', final_algo, pure_train_data, final_test_data)
