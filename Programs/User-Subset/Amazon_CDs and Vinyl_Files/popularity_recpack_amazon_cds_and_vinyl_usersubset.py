# -*- coding: utf-8 -*-
"""Popularity_RecPack_Amazon_CDs_and_Vinyl_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_WaoogqpzVaAJpRCZvV0Hsqj3jmarJUE
"""
...
def load_json_data(file_path, chunksize=100000):
...
# 28%----> 0.73      36%----> 0.58    44%-----> 0.47     52%----> 0.40     60%----> 0.35     68%----> 0.31      76%----> 0.285       84%----> 0.27       92%----> 0.235         100%----> 0.220
test_valid_fraction = 0.220
...
# 28%----> 0.47     36%----> 0.46    44%-----> 0.45         52%----> 0.46    60%----> 0.43    68%---> 0.425     76%---> 0.415      84%----> 0.42        92%----> 0.41       100%---> 0.41
test_valid_scenario = WeakGeneralization(frac_data_in=0.41, validation=False, seed=42)
...
pipeline_builder = pipelines.PipelineBuilder('Amazon_CDs_and_Vinyl')
