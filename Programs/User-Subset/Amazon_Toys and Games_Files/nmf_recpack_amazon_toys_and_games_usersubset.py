# -*- coding: utf-8 -*-
"""NMF_RecPack_Amazon_Toys_and_Games_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qrcpNrecGGJB5XrHUe8APiiuBwlAiLgT
"""
...
# 28%----> 0.74      36%----> 0.585     44%-----> 0.49     52%----> 0.41     60%----> 0.365     68%----> 0.32      76%----> 0.295       84%----> 0.27       92%----> 0.249         100%----> 0.229
...
# 28%----> 0.46     36%----> 0.44    44%-----> 0.43         52%----> 0.43    60%----> 0.41    68%---> 0.37     76%---> 0.39      84%----> 0.39        92%----> 0.38       100%---> 0.40
