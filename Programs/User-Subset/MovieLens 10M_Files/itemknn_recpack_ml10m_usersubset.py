# -*- coding: utf-8 -*-
"""ItemKNN_RecPack_ML10M_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1C6Cbv8pEqp3blTTk7b0TWvSPlR1TA_bY
"""
...
preprocessed_file_path = '/content/drive/MyDrive/Master Thesis/Dataset/ml-10m/preprocessed_ratings(for_RecPack_UserSubset).csv'
downsampled_ratings.to_csv(preprocessed_file_path, index=False)

# Create an instance of MovieLens10M with the preprocessed file
...
# 28%----> 0.72      36%----> 0.56     44%-----> 0.46     52%----> 0.385     60%----> 0.335     68%----> 0.295      76%----> 0.265       84%----> 0.24       92%----> 0.22         100%----> 0.205
...
# 28%----> 0.495     36%----> 0.495    44%-----> 0.495         52%----> 0.495    60%----> 0.495    68%---> 0.49     76%---> 0.49      84%----> 0.49        92%----> 0.49      100%---> 0.49
test_valid_scenario = WeakGeneralization(frac_data_in=0.49, validation=False, seed=42)
...
pipeline_builder.add_algorithm(
    'ItemKNN',
    grid={
        'K': [1, 10, 20, 40, 50, 70, 100, 150, 200, 300, 350, 400, 500, 600, 700, 800, 900, 1000],  # Range of K values for optimization
    }
)
