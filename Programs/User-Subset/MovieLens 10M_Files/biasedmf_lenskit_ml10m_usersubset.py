# -*- coding: utf-8 -*-
"""BiasedMF(Updated_nDCG)_LensKit_ML10M_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Uy6Wo9xOeFKSqHS3UFR5jw0Zgk_89MGM
"""
...
# 28--> 0.36     36---> 0.28   44---> 0.23     52---> 0.19     60---> 0.165     68---> 0.15      76-----> 0.13     84----> 0.12         92----> 0.11        100-----> 0.10
...
# 28---> 0.56   36---> 0.385    44---> 0.29     52---> 0.235     60---> 0.20    68----> 0.17       76----> 0.15      84----> 0.135        92----> 0.12        100-----> 0.11
# Split train data into train and validation sets
validation_split_method = xf.SampleFrac(0.11, rng_spec=42)
...
feature_values = [80, 100, 120, 150, 200, 250, 300, 400]  # Define a range of feature values to test
iteration_values = [1, 10, 20, 50]  # Define a range of iteration values to test
