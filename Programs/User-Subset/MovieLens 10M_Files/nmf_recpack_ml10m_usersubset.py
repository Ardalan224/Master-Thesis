# -*- coding: utf-8 -*-
"""NMF_RecPack_ML10M_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bj8mJJLNl3DyEYK9H7qxq9Lce5LiPrCy
"""
...
pipeline_builder.add_algorithm(
    'NMF',
    grid={
        'num_components': [1, 5, 10, 15, 20, 25, 30, 35, 40, 50, 100],  # Range of number of components to test
        'alpha': [0, 0.001, 0.01],
        'seed': [42]
    }
)
