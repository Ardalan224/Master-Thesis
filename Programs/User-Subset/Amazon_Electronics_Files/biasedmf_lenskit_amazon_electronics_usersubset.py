# -*- coding: utf-8 -*-
"""BiasedMF(Updated_nDCG)_LensKit_Amazon_Electronics_UserSubset+UserBasedSplit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RO6BjLD_e3ta04GU6hFdiztACx6LowuO
"""
...
# 28--> 0.35     36---> 0.28   44---> 0.23     52---> 0.195     60---> 0.165     68---> 0.145      76-----> 0.135     84----> 0.12         92----> 0.115        100-----> 0.10
# Split into train and test sets
final_test_method = xf.SampleFrac(0.115, rng_spec=42)
...
# 28---> 0.56   36---> 0.38    44---> 0.30     52---> 0.24     60---> 0.19    68----> 0.17       76----> 0.15      84----> 0.14        92----> 0.125        100-----> 0.11
# Split train data into train and validation sets
validation_split_method = xf.SampleFrac(0.125, rng_spec=42)
...
feature_values = [50, 80, 100, 120, 150, 200, 300, 400, 500]  # Define a range of feature values to test
