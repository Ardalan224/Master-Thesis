# -*- coding: utf-8 -*-
"""UserKNN_LensKit_ML10M_Automated Fine tuned+K fold.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CqJOai-YXO_76XDrV_l6dxHg95KzCZoA
"""
...
from lenskit.algorithms import Recommender, user_knn as knn  # Import UserKNN
...
plt.xlabel('Rating')
plt.ylabel('Count')
plt.title('Distribution of Ratings ML 10M')
plt.show()
...
for k in [1, 2, 5, 10, 20, 100]:  # Iterate over K values from 1 to 20
    seedbank.initialize(1)
...
algo_uu_best = knn.UserUser(best_k)  # Use UserUser instead of ItemItem
